...
func TestGeneratedObservationMetadata(t *testing.T) {
	...
	state, _, err := codecs.State.Decode(json.RawMessage("18"))
	if err != nil {
	...
	if entitytypetest.CanonicalJSON(t, observation.Value) != entitytypetest.CanonicalJSON(t, json.RawMessage("18")) {
...
func TestGeneratedEntityDescriptor(t *testing.T) {
	...
	if descriptor.Type != "hearth.numericsensor/v1" {
