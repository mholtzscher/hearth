...
func TestGeneratedObservationConformance(t *testing.T) {
	...
	t.Run("relative-humidity-percent-range", func(t *testing.T) {
		support, _, err := codecs.Support.Decode(json.RawMessage("{\n        \"state\": {\n          \"measurement_kind\": \"relative_humidity\",\n          \"unit\": \"%\",\n          \"minimum\": 0,\n          \"maximum\": 100\n        },\n        \"operations\": {}\n      }"))
		if err != nil {
			t.Fatalf("support: %v", err)
		}
		{
	...
	t.Run("illuminance-lux-range", func(t *testing.T) {
		support, _, err := codecs.Support.Decode(json.RawMessage("{\n        \"state\": {\n          \"measurement_kind\": \"illuminance\",\n          \"unit\": \"lx\",\n          \"minimum\": 0,\n          \"maximum\": 1000000000\n        },\n        \"operations\": {}\n      }"))
		if err != nil {
			t.Fatalf("support: %v", err)
		}
		{
		...
		{
			raw := json.RawMessage("1000000000")
			state, _, codecErr := codecs.State.Decode(raw)
			if codecErr != nil {
				t.Errorf("State example 3 marked valid but rejected by State codec: %v", codecErr)
			}
		...
		{
			raw := json.RawMessage("1000000000.5")
			state, _, codecErr := codecs.State.Decode(raw)
			var plainState State
			plainErr := json.Unmarshal(raw, &plainState)
			if codecErr == nil {
	...
	t.Run("battery-level-percent-range", func(t *testing.T) {
		support, _, err := codecs.Support.Decode(json.RawMessage("{\n        \"state\": {\n          \"measurement_kind\": \"battery_level\",\n          \"unit\": \"%\",\n          \"minimum\": 0,\n          \"maximum\": 100\n        },\n        \"operations\": {}\n      }"))
		if err != nil {
			t.Fatalf("support: %v", err)
		}
		{
...
func TestGeneratedObservationMetadata(t *testing.T) {
	...
	state, _, err := codecs.State.Decode(json.RawMessage("-273.15"))
	if err != nil {
	...
	if entitytypetest.CanonicalJSON(t, observation.Value) != entitytypetest.CanonicalJSON(t, json.RawMessage("-273.15")) {
...
func TestGeneratedEntityDescriptor(t *testing.T) {
	...
	if descriptor.Type != "hearth.measurement/v1" {
	...
	{
		invalidSupport2, _, err := codecs.Support.Decode(json.RawMessage("{\n      \"state\": {\n        \"measurement_kind\": \"relative_humidity\",\n        \"unit\": \"%\",\n        \"minimum\": 100,\n        \"maximum\": 0\n      },\n      \"operations\": {}\n    }"))
		if err != nil {
			t.Fatalf("invalid support 2: %v", err)
		}
		if _, err := NewEntityDescriptor(metadata, invalidSupport2); err == nil {
			t.Error("descriptor with invalid Entity support 2 was accepted")
		} else {
			adaptertest.RequireValidationError(t, err, "reject invalid Entity support 2")
		}
	}
	{
		invalidSupport3, _, err := codecs.Support.Decode(json.RawMessage("{\n      \"state\": {\n        \"measurement_kind\": \"illuminance\",\n        \"unit\": \"lx\",\n        \"minimum\": 1000000000,\n        \"maximum\": 0\n      },\n      \"operations\": {}\n    }"))
		if err != nil {
			t.Fatalf("invalid support 3: %v", err)
		}
		if _, err := NewEntityDescriptor(metadata, invalidSupport3); err == nil {
			t.Error("descriptor with invalid Entity support 3 was accepted")
		} else {
			adaptertest.RequireValidationError(t, err, "reject invalid Entity support 3")
		}
	}
	{
		invalidSupport4, _, err := codecs.Support.Decode(json.RawMessage("{\n      \"state\": {\n        \"measurement_kind\": \"battery_level\",\n        \"unit\": \"%\",\n        \"minimum\": 100,\n        \"maximum\": 0\n      },\n      \"operations\": {}\n    }"))
		if err != nil {
			t.Fatalf("invalid support 4: %v", err)
		}
		if _, err := NewEntityDescriptor(metadata, invalidSupport4); err == nil {
			t.Error("descriptor with invalid Entity support 4 was accepted")
		} else {
			adaptertest.RequireValidationError(t, err, "reject invalid Entity support 4")
		}
	}
}
