...
func TestGeneratedObservationConformance(t *testing.T) {
	...
	t.Run("fixed-range-milli-celsius", func(t *testing.T) {
		support, _, err := codecs.Support.Decode(json.RawMessage("{\"state\": {\"unit\": \"mCel\"}, \"operations\": {}}"))
		if err != nil {
			t.Fatalf("support: %v", err)
		}
		{
			raw := json.RawMessage("21500")
...
func TestGeneratedObservationMetadata(t *testing.T) {
	...
	state, _, err := codecs.State.Decode(json.RawMessage("21500"))
	if err != nil {
	...
	if entitytypetest.CanonicalJSON(t, observation.Value) != entitytypetest.CanonicalJSON(t, json.RawMessage("21500")) {
...
func TestGeneratedObservationValidation(t *testing.T) {
	...
	invalidSupport.State.Unit = "mCel-invalid"
...
func TestGeneratedEntityDescriptor(t *testing.T) {
	...
	if descriptor.Type != "hearth.temperature/v1" {
		t.Errorf("descriptor type = %q", descriptor.Type)
	}
	if entitytypetest.CanonicalJSON(t, descriptor.Support) != entitytypetest.CanonicalJSON(t, json.RawMessage("{\"state\": {\"unit\": \"mCel\"}, \"operations\": {}}")) {
