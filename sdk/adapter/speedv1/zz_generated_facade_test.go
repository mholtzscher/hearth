...
func TestGeneratedObservationConformance(t *testing.T) {
	...
	t.Run("metres-per-second-envelope", func(t *testing.T) {
		support, _, err := codecs.Support.Decode(json.RawMessage("{\"state\": {\"unit\": \"m/s\"}, \"operations\": {}}"))
		if err != nil {
...
func TestGeneratedObservationValidation(t *testing.T) {
	...
	invalidSupport.State.Unit = "m/s-invalid"
...
func TestGeneratedEntityDescriptor(t *testing.T) {
	...
	if entitytypetest.CanonicalJSON(t, descriptor.Support) != entitytypetest.CanonicalJSON(t, json.RawMessage("{\"state\": {\"unit\": \"m/s\"}, \"operations\": {}}")) {
