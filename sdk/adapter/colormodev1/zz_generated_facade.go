...
func NewEntityDescriptor(metadata adapter.EntityMetadata, support Support) (adapter.EntityDescriptor, error) {
	...
	descriptor, err := typed.NewTypedEntityDescriptor(metadata, contractcolormodev1.TypeID, support, codecs.Support)
	if err != nil {
		return adapter.EntityDescriptor{}, err
	}
	if err := contractcolormodev1.ValidateSupport(support); err != nil {
