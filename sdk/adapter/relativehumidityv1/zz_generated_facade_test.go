...
func TestGeneratedObservationConformance(t *testing.T) {
	...
	t.Run("percent-envelope", func(t *testing.T) {
		support, _, err := codecs.Support.Decode(json.RawMessage("{\"state\": {\"unit\": \"%\"}, \"operations\": {}}"))
		if err != nil {
...
func TestGeneratedObservationValidation(t *testing.T) {
	...
	invalidSupport.State.Unit = "%-invalid"
...
func TestGeneratedEntityDescriptor(t *testing.T) {
	...
	if descriptor.Type != "hearth.relativehumidity/v1" {
		t.Errorf("descriptor type = %q", descriptor.Type)
	}
	if entitytypetest.CanonicalJSON(t, descriptor.Support) != entitytypetest.CanonicalJSON(t, json.RawMessage("{\"state\": {\"unit\": \"%\"}, \"operations\": {}}")) {
