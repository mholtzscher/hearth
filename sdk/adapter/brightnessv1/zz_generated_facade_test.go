...
func TestGeneratedObservationMetadata(t *testing.T) {
	...
	if canonicalJSON(t, observation.Value) != canonicalJSON(t, json.RawMessage("75")) {
...
func TestGeneratedCommandConformance(t *testing.T) {
	...
	t.Run("maximum-80-step-5", func(t *testing.T) {
		...
		if canonicalValue(t, receivedSet.Parameters) != canonicalJSON(t, json.RawMessage("{\"value\": 75}")) {
