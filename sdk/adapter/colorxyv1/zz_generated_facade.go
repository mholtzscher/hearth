...
func NewEntityDescriptor(metadata adapter.EntityMetadata, support Support) (adapter.EntityDescriptor, error) {
	...
	return adapter.EntityDescriptor{Key: metadata.Key, ExternalID: metadata.ExternalID, Name: metadata.Name, Type: contractcolorxyv1.TypeID, Support: normalized}, nil
}
...
func NewObservation(input ObservationInput) (adapter.Observation, error) {
	...
	if err := contractcolorxyv1.ValidateState(input.Support, input.State); err != nil {
