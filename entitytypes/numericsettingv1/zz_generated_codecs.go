...
const (
	StateSchemaID         = "urn:hearth:schema:entity-type:numericsetting:v1:state"
	SupportSchemaID       = "urn:hearth:schema:entity-type:numericsetting:v1:support"
	SetParametersSchemaID = "urn:hearth:schema:entity-type:numericsetting:v1:set-parameters"
)
...
func Compile() (*Codecs, error) {
	...
	setParameters, err := compileCodec[SetParameters](SetParametersSchemaID, SchemaFiles()[SetParametersSchemaID])
	if err != nil {
		return nil, err
	}
	return &Codecs{State: state, Support: support, SetParameters: setParameters}, nil
}
