...
const (
	StateSchemaID         = "urn:hearth:schema:entity-type:colorxy:v1:state"
	SupportSchemaID       = "urn:hearth:schema:entity-type:colorxy:v1:support"
	SetParametersSchemaID = "urn:hearth:schema:entity-type:colorxy:v1:set-parameters"
)
