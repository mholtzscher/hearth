...
const (
	StateSchemaID         = "urn:hearth:schema:entity-type:colorhs:v1:state"
	SupportSchemaID       = "urn:hearth:schema:entity-type:colorhs:v1:support"
	SetParametersSchemaID = "urn:hearth:schema:entity-type:colorhs:v1:set-parameters"
)
