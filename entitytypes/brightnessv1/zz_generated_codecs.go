...
const (
	StateSchemaID         = "urn:hearth:schema:entity-type:brightness:v1:state"
	SupportSchemaID       = "urn:hearth:schema:entity-type:brightness:v1:support"
	SetParametersSchemaID = "urn:hearth:schema:entity-type:brightness:v1:set-parameters"
)
