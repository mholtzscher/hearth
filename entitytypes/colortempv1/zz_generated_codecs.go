...
const (
	StateSchemaID         = "urn:hearth:schema:entity-type:colortemp:v1:state"
	SupportSchemaID       = "urn:hearth:schema:entity-type:colortemp:v1:support"
	SetParametersSchemaID = "urn:hearth:schema:entity-type:colortemp:v1:set-parameters"
)
