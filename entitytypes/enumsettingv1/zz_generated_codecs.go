...
const (
	StateSchemaID         = "urn:hearth:schema:entity-type:enumsetting:v1:state"
	SupportSchemaID       = "urn:hearth:schema:entity-type:enumsetting:v1:support"
	SetParametersSchemaID = "urn:hearth:schema:entity-type:enumsetting:v1:set-parameters"
)
